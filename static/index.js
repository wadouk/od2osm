...
var $author$project$Main$Model = F5(
	function (navigationKey, flags, origin, login, password) {
		return {flags: flags, login: login, navigationKey: navigationKey, origin: origin, password: password};
	});
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		return _Utils_Tuple2(
			A5($author$project$Main$Model, navigationKey, mflags, origin, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
...
var $author$project$Main$UserDetailsFetched = function (a) {
...
var $billstclair$elm_xml_eeue56$Xml$DocType = F2(
	function (a, b) {
		return {$: 'DocType', a: a, b: b};
	});
...
var $billstclair$elm_xml_eeue56$Xml$FloatNode = function (a) {
	return {$: 'FloatNode', a: a};
};
var $elm$core$String$toFloat = _String_toFloat;
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeFloat = function (str) {
	var _v0 = $elm$core$String$toFloat(str);
	if (_v0.$ === 'Nothing') {
		return $elm$core$Result$Err('could not convert string \'' + (str + '\' to a Float'));
	} else {
		var v = _v0.a;
		return $elm$core$Result$Ok(
			$billstclair$elm_xml_eeue56$Xml$FloatNode(v));
	}
};
var $billstclair$elm_xml_eeue56$Xml$IntNode = function (a) {
	return {$: 'IntNode', a: a};
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeInt = function (str) {
	var _v0 = $elm$core$String$toInt(str);
	if (_v0.$ === 'Nothing') {
		return $elm$core$Result$Err('could not convert string \'' + (str + '\' to an Int'));
	} else {
		var v = _v0.a;
		return $elm$core$Result$Ok(
			$billstclair$elm_xml_eeue56$Xml$IntNode(v));
	}
};
var $billstclair$elm_xml_eeue56$Xml$StrNode = function (a) {
	return {$: 'StrNode', a: a};
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeString = function (str) {
	return $elm$core$Result$Ok(
		$billstclair$elm_xml_eeue56$Xml$StrNode(str));
};
...
var $billstclair$elm_xml_eeue56$Xml$BoolNode = function (a) {
	return {$: 'BoolNode', a: a};
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeBool = function (str) {
	return (str === 'true') ? $elm$core$Result$Ok(
		$billstclair$elm_xml_eeue56$Xml$BoolNode(true)) : ((str === 'false') ? $elm$core$Result$Ok(
		$billstclair$elm_xml_eeue56$Xml$BoolNode(false)) : $elm$core$Result$Err('Not a bool'));
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeProps = function (str) {
	return A3(
		$elm$core$List$foldl,
		F2(
		...
		$elm$core$Result$Err(''),
		_List_fromArray(
			[$billstclair$elm_xml_eeue56$Xml$Decode$decodeBool, $billstclair$elm_xml_eeue56$Xml$Decode$decodeInt, $billstclair$elm_xml_eeue56$Xml$Decode$decodeFloat, $billstclair$elm_xml_eeue56$Xml$Decode$decodeString]));
};
...
var $billstclair$elm_xml_eeue56$Xml$Decode$parseProps = $elm$core$List$filterMap(
	function (n) {
		var _v0 = A2($elm$core$String$split, '=', n);
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			...
			var withoutQuotes = A2(
				...
				1,
				A2($elm$core$String$dropLeft, 1, value));
			var _v2 = $billstclair$elm_xml_eeue56$Xml$Decode$decodeProps(withoutQuotes);
			if (_v2.$ === 'Err') {
				return $elm$core$Maybe$Nothing;
			} else {
				var v = _v2.a;
...
var $billstclair$elm_xml_eeue56$Xml$Decode$propRegex = $elm$regex$Regex$fromString(' .+?=\".+?\"');
...
var $billstclair$elm_xml_eeue56$Xml$Decode$findProps = function () {
	var _v0 = $billstclair$elm_xml_eeue56$Xml$Decode$propRegex;
	if (_v0.$ === 'Nothing') {
		return function (_v1) {
			return $elm$core$Dict$empty;
		};
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2($elm$core$Basics$composeR, $billstclair$elm_xml_eeue56$Xml$Decode$parseProps, $elm$core$Dict$fromList)))))));
	}
}();
...
var $billstclair$elm_xml_eeue56$Xml$Decode$actualDecode = function (text) {
	var openIndexes = A2($elm$core$String$indexes, '<', text);
	var closeIndexes = A2($elm$core$String$indexes, '>', text);
	var _v4 = _Utils_Tuple2(openIndexes, closeIndexes);
	if (_v4.a.b && _v4.b.b) {
		var _v5 = _v4.a;
		var first = _v5.a;
		var restFirst = _v5.b;
		var _v6 = _v4.b;
		var firstClose = _v6.a;
		var restFirstClose = _v6.b;
		return A2(
			$elm$core$Result$andThen,
			function (_v7) {
				var foundValue = _v7.a;
				var firstCloseTag = _v7.b;
				var _v8 = $billstclair$elm_xml_eeue56$Xml$Decode$actualDecode(
					A3(
						$elm$core$String$slice,
						firstCloseTag,
						$elm$core$String$length(text) + 1,
						text));
				if (_v8.$ === 'Err') {
					var err = _v8.a;
					return (err === 'Nothing left') ? $elm$core$Result$Ok(
						_List_fromArray(
							[foundValue])) : $elm$core$Result$Err(
						'Parsed to ' + (A2($billstclair$elm_xml_eeue56$Xml$Encode$encode, 0, foundValue) + (', but then hit ' + err)));
				} else {
					var thing = _v8.a;
					return $elm$core$Result$Ok(
						_Utils_ap(
			...
			A3($billstclair$elm_xml_eeue56$Xml$Decode$parseSlice, first, firstClose, text));
	} else {
		return $elm$core$Result$Err('Nothing left');
	}
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decode = function (text) {
	var _v3 = $elm$core$String$trim(text);
	if (_v3 === '') {
		return $elm$core$Result$Ok(
			$billstclair$elm_xml_eeue56$Xml$Object(_List_Nil));
	} else {
		var trimmed = _v3;
		return A2(
			$elm$core$Result$map,
			$billstclair$elm_xml_eeue56$Xml$Object,
			$billstclair$elm_xml_eeue56$Xml$Decode$actualDecode(trimmed));
	}
};
var $billstclair$elm_xml_eeue56$Xml$Decode$decodeChildren = function (str) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (decoder, val) {
		...
		$elm$core$Result$Err(''),
		_List_fromArray(
			[$billstclair$elm_xml_eeue56$Xml$Decode$decode, $billstclair$elm_xml_eeue56$Xml$Decode$decodeInt, $billstclair$elm_xml_eeue56$Xml$Decode$decodeFloat, $billstclair$elm_xml_eeue56$Xml$Decode$decodeString]));
};
var $billstclair$elm_xml_eeue56$Xml$Decode$parseSlice = F3(
	function (first, firstClose, trimmed) {
		var beforeClose = A3($elm$core$String$slice, first + 1, firstClose, trimmed);
		var words = $elm$core$String$words(beforeClose);
		var props = $billstclair$elm_xml_eeue56$Xml$Decode$findProps(words);
		var tagName = A2(
			$elm$core$Maybe$withDefault,
			'',
			$elm$core$List$head(words));
		var closeTag = '</' + (tagName + '>');
		var _v0 = A2($elm$core$String$indexes, closeTag, trimmed);
		if (!_v0.b) {
			if (A2($elm$core$String$startsWith, '?', tagName)) {
				return $elm$core$Result$Ok(
					_Utils_Tuple2(
						A2($billstclair$elm_xml_eeue56$Xml$DocType, tagName, props),
						firstClose + 1));
			} else {
				if (A2($elm$core$String$endsWith, '/', beforeClose)) {
					var tag = A2($elm$core$String$endsWith, '/', tagName) ? A3($elm$core$String$slice, 0, -1, tagName) : tagName;
					return $elm$core$Result$Ok(
						_Utils_Tuple2(
							A3(
								$billstclair$elm_xml_eeue56$Xml$Tag,
								tag,
								props,
								$billstclair$elm_xml_eeue56$Xml$Object(_List_Nil)),
							firstClose + 1));
				} else {
					return $elm$core$Result$Err('Failed to find close tag for ' + tagName);
				}
			}
		} else {
			var firstCloseTag = _v0.a;
			var contents = A3($elm$core$String$slice, firstClose + 1, firstCloseTag, trimmed);
			var _v1 = $billstclair$elm_xml_eeue56$Xml$Decode$decodeChildren(contents);
			if (_v1.$ === 'Err') {
				var s = _v1.a;
				...
				return $elm$core$Result$Ok(
					_Utils_Tuple2(
						A3($billstclair$elm_xml_eeue56$Xml$Tag, tagName, props, v),
						firstCloseTag + $elm$core$String$length(closeTag)));
			}
		}
	});
...
var $billstclair$elm_xml_eeue56$Xml$Query$int = function (value) {
	if (value.$ === 'IntNode') {
		var n = value.a;
		return $elm$core$Result$Ok(n);
	} else {
		return $elm$core$Result$Err('Not an int');
	}
};
...
var $billstclair$elm_xml_eeue56$Xml$Query$string = function (value) {
	if (value.$ === 'StrNode') {
		var s = value.a;
...
var $billstclair$elm_xml_eeue56$Xml$Query$tags = F2(
	function (tagName, node) {
		switch (node.$) {
			...
			case 'Tag':
				...
				var value = node.c;
				return _Utils_ap(
					_Utils_eq(name, tagName) ? _List_fromArray(
						[node]) : _List_Nil,
					A2($billstclair$elm_xml_eeue56$Xml$Query$tags, tagName, value));
			default:
				var nodes = node.a;
				return $elm$core$List$concat(
					A2(
						$elm$core$List$map,
						$billstclair$elm_xml_eeue56$Xml$Query$tags(tagName),
						nodes));
		}
	});
var $billstclair$elm_xml_eeue56$Xml$Query$tag = F3(
	function (name, converter, value) {
		tag:
		while (true) {
			var _v0 = A2($billstclair$elm_xml_eeue56$Xml$Query$tags, name, value);
			if (!_v0.b) {
				return $elm$core$Result$Err('No tag called \'' + (name + '\' found.'));
			} else {
				var firstTag = _v0.a;
				_v1$2:
				while (true) {
					switch (firstTag.$) {
						case 'Tag':
							var nextValue = firstTag.c;
							return converter(nextValue);
						case 'Object':
							if (firstTag.a.b) {
								var _v2 = firstTag.a;
								var x = _v2.a;
				...
				return $elm$core$Result$Err('Not a tag');
			}
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'FetchUserDetails':
				var l = msg.a;
				var p = msg.b;
				var url = 'https://api.openstreetmap.org/api/0.6/user/details';
				var e = $danfishgold$base64_bytes$Base64$fromBytes(
					$elm$bytes$Bytes$Encode$encode(
						$elm$bytes$Bytes$Encode$string(l + (':' + p))));
				var cmd = A2(
					$elm$core$Maybe$withDefault,
					$elm$core$Platform$Cmd$none,
					A2(
							...
							return $elm$http$Http$request(
								{
									...
									expect: $elm$http$Http$expectString($author$project$Main$UserDetailsFetched),
				...
				if (msg.a.$ === 'Ok') {
					...
					var person = function (value) {
						return A3(
							...
							A3($billstclair$elm_xml_eeue56$Xml$Query$tag, 'id', $billstclair$elm_xml_eeue56$Xml$Query$int, value),
							A3($billstclair$elm_xml_eeue56$Xml$Query$tag, 'display_name', $billstclair$elm_xml_eeue56$Xml$Query$string, value));
					};
					var root = function (value) {
						return A2(
							...
							A3($billstclair$elm_xml_eeue56$Xml$Query$tag, 'osm', person, value));
					};
					var decodedXml = A2(
						$elm$core$Maybe$withDefault,
						$billstclair$elm_xml_eeue56$Xml$Encode$null,
						$elm$core$Result$toMaybe(
							$billstclair$elm_xml_eeue56$Xml$Decode$decode(s)));
					var people = A2(
						$elm$core$Result$map,
						function ($) {
							return $.x;
						...
						root(decodedXml));
					var _v1 = A2($elm$core$Debug$log, 'xml', decodedXml);
					var _v2 = A2($elm$core$Debug$log, 'xml', people);
				...
				if (msg.a === '') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								password: $elm$core$Maybe$Just(s)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$FetchUserDetails = F2(
	function (a, b) {
		return {$: 'FetchUserDetails', a: a, b: b};
	});
var $author$project$Main$InputLogin = function (a) {
	return {$: 'InputLogin', a: a};
};
						...
						_List_fromArray(
							[
								...
								A2(
									...
									A3($elm$core$Maybe$map2, $author$project$Main$FetchUserDetails, model.login, model.password)))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput($author$project$Main$InputLogin)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$label,
